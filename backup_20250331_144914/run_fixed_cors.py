...
if __name__ == "__main__":
    ...
    print("Starting Wikipedia TTS Application with fixed CORS...")
    ...
    # Start the Flask backend server with the fixed CORS server
    print("Starting Flask backend server with fixed CORS...")
    flask_process = run_command(
        "python3 fixed_cors_server.py",
        cwd=current_dir
    )
