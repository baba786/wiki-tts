...
if __name__ == "__main__":
    ...
    print("Starting Wikipedia TTS Application with Coqui TTS...")
    ...
    print("Starting Flask backend server with Coqui TTS support...")
    ...
    try:
        print("\nServers are running!")
        print("Flask backend with Coqui TTS: http://localhost:5000")
